...
class LocalJSONStore(UserQueryDataStore):
    ...
    def save_dataset(self, abstracts_data: List[ScientificAbstract], user_query: str,
                     query_simplified: str, medical_notes: str = None) -> str:
        """
    ...
    def _rebuild_index(self) -> Dict[str, str]:
        ...
        index = {}
        query_data_paths = [os.path.join(self.storage_folder_path, name) for name in
                            os.listdir(self.storage_folder_path)
