...
class UserQueryDataStore(ABC):
    ...
    @abstractmethod
    def save_dataset(
            self, abstracts_data: List[ScientificAbstract], user_query: str, simplified_query: str) -> str:
        """
    ...
    @staticmethod
    def create_document_list(abstracts_data: List[ScientificAbstract]) -> List[Document]:
        return [
            Document(
