...
class ChatAgent:
    ...
    @staticmethod
    def retrieve_documents(retriever: VectorStore, question: str, cut_off: int = 5) -> List[Document]:
        """
    ...
    def start_conversation(self, retriever: VectorStore, selected_query: str) -> None:
        ...
        if user_question:
            ...
            retrieved_abstracts = self.format_retrieved_abstracts_for_prompt(documents)
